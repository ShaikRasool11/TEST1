	...
	public void validate_that_the_URL_contains_simple_form_demo() throws Throwable {
		 String url=driver.getCurrentUrl();
	      ...
	      if(url.contains("simple-form-demo")) {
	          System.out.println("URL verification  successful of verification page");
			}
...
String msg;
	...
	public void validate_whether_the_same_text_message_is_displayed_under_the_Your_Message_section() throws Throwable {
		...
		Assert.assertEquals(actual,msg);
	     ...
	     {
	    	 System.out.println("Welcome to lambda test Displayed correctly");
	     }
	     else
	     {
	    	 System.out.println("Wrong display of lambda test");
	     }*/
		 driver.close();
	}
